...
class App extends React.Component {
    ...
    deleteToDo(id){
        ...
        axios.delete(`http://192.168.0.25:8000/api/todo/${id}/`, {headers} )
    ...
    createToDo(description, project, user){
        ...
        axios.post('http://192.168.0.25:8000/api/todo/', data, {headers:headers})
        .then(response => {
    ...
    deleteProject(id){
        const headers = this.get_headers()
        axios.delete(`http://192.168.0.25:8000/api/projects/${id}/`, {headers} )
    ...
    createProject(project_name, users, link_git, descriptions){
        ...
        axios.post('http://192.168.0.25:8000/api/projects/', data, {headers:headers})
        .then(response => {
	...
	get_token(username, password){
        axios.post('http://192.168.0.25:8000/api-token-auth/', {username:username, password:password})
        .then(response => {
    ...
    load_data(){
        const headers = this.get_headers()
        axios.get('http://192.168.0.25:8000/api/users/', {headers})
			.then(response => {
		...
		axios.get('http://192.168.0.25:8000/api/projects/', {headers})
			.then(response => {
	    ...
	    axios.get('http://192.168.0.25:8000/api/todo/', {headers})
			.then(response => {
